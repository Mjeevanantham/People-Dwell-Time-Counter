...
def main():
    cap = cv2.VideoCapture(r'P:\our project\video\test_video.mp4')
...
#founded
            if int(dwell_time[objectId])==20:
                server=smtplib.SMTP('smtp.gmail.com',587)
                server.starttls()
                server.login('devananth511@gmail.com','Deva@5112002')
                server.sendmail('devananth511@gmail.com','jeevanantham.cb20@bitsathy.ac.in','Warning....!!')
                print("email sent")
